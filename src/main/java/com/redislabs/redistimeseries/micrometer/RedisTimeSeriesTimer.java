...
/**
 * {@link io.micrometer.core.instrument.Timer} for RedisTimeSeries.
 *
 * @author Jon Schneider
 * @author Nikolay Ustinov
 * @author Julien Ruaux
 */
public class RedisTimeSeriesTimer extends AbstractTimer {
	...
	RedisTimeSeriesTimer(Id id, Clock clock, DistributionStatisticConfig distributionStatisticConfig,
		...
		if (distributionStatisticConfig.isPublishingHistogram()) {
			histogram = new TimeWindowFixedBoundaryHistogram(clock,
					DistributionStatisticConfig.builder().expiry(Duration.ofDays(1825)) // effectively never roll over
